...
json_file = open('/home/ubuntu/keras/enver/dmlh2/models/dmlh2_512_model.json', 'r')
model = json_file.read()
json_file.close()
model = model_from_json(model)
model.load_weights("/home/ubuntu/keras/enver/dmlh2/models/dmlh2_512_weights.h5")
