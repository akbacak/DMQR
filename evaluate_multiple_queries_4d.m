...
load('lamdaDataset/hashCodes/hashCodes_128.mat');
load('lamdaDataset/hashCodes/targets.mat');
    ...
    queryIndex = xlsread('qLabels_4d.xls');  % Reads randomly choosen query pairs from excell file
    ...
    queryIndex4 = queryIndex(4,:);        % Second element of Query Pair
    ...
    for l = 1:250                  % Number of Query Pairs
        ...
        norm_hamming_dist4{l,:} =  hamming_dist4{l,:} / max( hamming_dist2{l,:}(:) );
        %norm_hamming_dist5{l,:} =  hamming_dist5{l,:} / max( hamming_dist3{l,:}(:) );
        ...
        for j  =1:maxFront
            ...
            Labels{l,j} = targets(pf_idx{j,1}(:,5),:);
