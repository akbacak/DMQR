function varargout = dmqRetrieval_4d(varargin)
% DMQRETRIEVAL_4D MATLAB code for dmqRetrieval_4d.fig
%      DMQRETRIEVAL_4D, by itself, creates a new DMQRETRIEVAL_4D or raises the existing
%      singleton*.
%
%      H = DMQRETRIEVAL_4D returns the handle to a new DMQRETRIEVAL_4D or the handle to
%      the existing singleton*.
%
%      DMQRETRIEVAL_4D('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DMQRETRIEVAL_4D.M with the given input arguments.
%
%      DMQRETRIEVAL_4D('Property','Value',...) creates a new DMQRETRIEVAL_4D or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dmqRetrieval_4d_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dmqRetrieval_4d_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dmqRetrieval_4d

% Last Modified by GUIDE v2.5 20-Apr-2020 23:49:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dmqRetrieval_4d_OpeningFcn, ...
                   'gui_OutputFcn',  @dmqRetrieval_4d_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dmqRetrieval_4d is made visible.
function dmqRetrieval_4d_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dmqRetrieval_4d (see VARARGIN)

% Choose default command line output for dmqRetrieval_4d
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dmqRetrieval_4d wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dmqRetrieval_4d_OutputFcn(hObject, eventdata, handles) 
...
[frontSize, e] = size(pf_idx{currentFront,1}(:,5));
