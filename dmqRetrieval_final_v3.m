function varargout = dmqRetrieval_final_v3(varargin)
% DMQRETRIEVAL_FINAL_V3 MATLAB code for dmqRetrieval_final_v3.fig
%      DMQRETRIEVAL_FINAL_V3, by itself, creates a new DMQRETRIEVAL_FINAL_V3 or raises the existing
%      singleton*.
%
%      H = DMQRETRIEVAL_FINAL_V3 returns the handle to a new DMQRETRIEVAL_FINAL_V3 or the handle to
%      the existing singleton*.
%
%      DMQRETRIEVAL_FINAL_V3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DMQRETRIEVAL_FINAL_V3.M with the given input arguments.
%
%      DMQRETRIEVAL_FINAL_V3('Property','Value',...) creates a new DMQRETRIEVAL_FINAL_V3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dmqRetrieval_final_v3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dmqRetrieval_final_v3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dmqRetrieval_final_v3

% Last Modified by GUIDE v2.5 06-Dec-2018 13:33:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dmqRetrieval_final_v3_OpeningFcn, ...
                   'gui_OutputFcn',  @dmqRetrieval_final_v3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dmqRetrieval_final_v3 is made visible.
function dmqRetrieval_final_v3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dmqRetrieval_final_v3 (see VARARGIN)

% Choose default command line output for dmqRetrieval_final_v3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dmqRetrieval_final_v3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dmqRetrieval_final_v3_OutputFcn(hObject, eventdata, handles) 
