function varargout = TEST_dmqRetrieval_final(varargin)
% TEST_DMQRETRIEVAL_FINAL MATLAB code for TEST_dmqRetrieval_final.fig
%      TEST_DMQRETRIEVAL_FINAL, by itself, creates a new TEST_DMQRETRIEVAL_FINAL or raises the existing
%      singleton*.
%
%      H = TEST_DMQRETRIEVAL_FINAL returns the handle to a new TEST_DMQRETRIEVAL_FINAL or the handle to
%      the existing singleton*.
%
%      TEST_DMQRETRIEVAL_FINAL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TEST_DMQRETRIEVAL_FINAL.M with the given input arguments.
%
%      TEST_DMQRETRIEVAL_FINAL('Property','Value',...) creates a new TEST_DMQRETRIEVAL_FINAL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before TEST_dmqRetrieval_final_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to TEST_dmqRetrieval_final_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help TEST_dmqRetrieval_final

% Last Modified by GUIDE v2.5 09-Dec-2018 01:33:46

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @TEST_dmqRetrieval_final_OpeningFcn, ...
                   'gui_OutputFcn',  @TEST_dmqRetrieval_final_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before TEST_dmqRetrieval_final is made visible.
function TEST_dmqRetrieval_final_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to TEST_dmqRetrieval_final (see VARARGIN)

% Choose default command line output for TEST_dmqRetrieval_final
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes TEST_dmqRetrieval_final wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = TEST_dmqRetrieval_final_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes during object creation, after setting all properties.
function FrontSelector2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to FrontSelector2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function FrontNum2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to FrontNum2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
