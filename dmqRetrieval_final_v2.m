function varargout = dmqRetrieval_final_v2(varargin)
% DMQRETRIEVAL_FINAL_V2 MATLAB code for dmqRetrieval_final_v2.fig
%      DMQRETRIEVAL_FINAL_V2, by itself, creates a new DMQRETRIEVAL_FINAL_V2 or raises the existing
%      singleton*.
%
%      H = DMQRETRIEVAL_FINAL_V2 returns the handle to a new DMQRETRIEVAL_FINAL_V2 or the handle to
%      the existing singleton*.
%
%      DMQRETRIEVAL_FINAL_V2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DMQRETRIEVAL_FINAL_V2.M with the given input arguments.
%
%      DMQRETRIEVAL_FINAL_V2('Property','Value',...) creates a new DMQRETRIEVAL_FINAL_V2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dmqRetrieval_final_v2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dmqRetrieval_final_v2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dmqRetrieval_final_v2

% Last Modified by GUIDE v2.5 06-Dec-2018 13:30:25

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dmqRetrieval_final_v2_OpeningFcn, ...
                   'gui_OutputFcn',  @dmqRetrieval_final_v2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dmqRetrieval_final_v2 is made visible.
function dmqRetrieval_final_v2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dmqRetrieval_final_v2 (see VARARGIN)

% Choose default command line output for dmqRetrieval_final_v2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dmqRetrieval_final_v2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dmqRetrieval_final_v2_OutputFcn(hObject, eventdata, handles) 
...
set(handles.tictoc,'String',num2str(t))
    ...
    set(handles.num_pp_fv2,'String',num2str(K))
...
q1_label = handles.q1_label;
q2_label = handles.q2_label;
...
system('gnome-terminal  -- python Python/run_python_on_matlab_96.py');
...
function num_pp_fv2_Callback(hObject, eventdata, handles)
% hObject    handle to num_pp_fv2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of num_pp_fv2 as text
%        str2double(get(hObject,'String')) returns contents of num_pp_fv2 as a double


% --- Executes during object creation, after setting all properties.
function num_pp_fv2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to num_pp_fv2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
